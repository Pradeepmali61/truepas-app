...
/**
 * Motion primitives for the API-reference screens.
 * Every action state gets a signature animation so the mockups read as
 * living screens, not screenshots. Specs are documented in docs/MOTION.md.
