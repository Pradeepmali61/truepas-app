...
import { STATUE_SVG } from '@/components/app/StatueOfLibertySvg';
...
export function DocIllustration({ type, minHeight = 130 }: { type: DocumentType; minHeight?: number }) {
  return (
    <View style={{
      ...
      {type === 'drivingLicense' ? (
        /* Driver's Licence ΓÇö light gradient bg, blue header, photo + signature + watermark */
        ...
        /* Passport ΓÇö light gold bg, black header strip with gold globe */
        <LinearGradient colors={['#FDF8E8', '#FAF3D0', '#F5EDB8']} locations={[0, 0.5, 1]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ flex: 1 }}>
          ...
          <View style={{ height: 22, flexDirection: 'row', alignItems: 'center', backgroundColor: '#0B1B2A', paddingHorizontal: 6, borderBottomWidth: 1, borderBottomColor: '#C9A84A' }}>
            ...
            <View style={{ flex: 1 }} />
            <AppIcon name="passport" size={12} color="#C9A84A" />
          </View>
        ...
        /* Green Card ΓÇö green header, statue watermark, photo + fields + fingerprint */
        ...
        /* Birth Certificate ΓÇö cream bg, ornate dark border, gothic title */
        ...
        /* US Visa ΓÇö realistic visa-style card with blue/red header strips */
        ...
        /* ID Card ΓÇö light indigo bg, gold header, photo + fields */
